...
+ Back End operations {#backend}
  ...
  + [Add A Command Line](backend/add-cli.md)
  + [Add A New Table To A Database](backend/add-new-table.md)
  + [Add A New Product Attribute](backend/add-product-attribute.md)
  + [Create A Custom Log File](backend/custom-log-file.md)  
  + [Create A Form](backend/create-form.md)
  + [Create A Grid](backend/create-grid.md)  
  + [Create A Module](backend/create-module.md)
  + [Create A New Page](backend/create-new-page.md)  
  + [Dependency Injection Example](backend/add-product-attribute.md)
  + [Developing Patches in Declarative Schema v2.3](backend/developing-patches-declarative-schema.md)   
  + [Keep Your Git Fork Updated](backend/di-example.md)
  + [Log Data To System File](backend/log-data-system-file.md)
  ...
  + [Place order Programmatically](backend/place-order-programmatically.md)  
  + [Plugins](backend/plugins.md)
  + [Registering An Event](backend/register-event.md)  
  + [Schema XSD](backend/schema-xsd.md)
  + [Simple Product Creation](backend/simple-product-creation-v2.md)  
  + [Specify Mode](backend/specify-mode.md)
  + [Splitting Price Indexer by Dimension and Run Indexation in Parallel Mode](backend/indexers.md)  
  + [Static Files](backend/static-files.md)
...
+ Migration {#migration}
  ...
  + [Data Migration Tool DMT Video 6 Delta and Completion](migration/dmt-6-delta.md)
